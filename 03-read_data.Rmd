...
A Rust class is a combination of a struct- (data) and an impl-block (functions). But as in R a package contains more important files and a folder structure.
...
The easiest way to start this is to use the Rust way of ''
